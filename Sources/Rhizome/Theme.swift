...
extension Color {
    ...
    static let rzRefHead = Color(red: 0.541, green: 0.608, blue: 0.659)  // web ref h3 (#8a9ba8)
    static let rzTint = Color(red: 0.960, green: 0.933, blue: 0.907)     // accent 5% on paper (ref-row box)
}
